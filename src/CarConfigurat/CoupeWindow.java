...
public class CoupeWindow extends JFrame{

	private static final long serialVersionUID = 1L;
	String imgPath2 = ".\\src\\CarConfigurat\\coupe.jpg";
	...
	public CoupeWindow() {
		...
		Coupe coupe1 = new Coupe(40000.00);
		
		radButBlue.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Color("blue"));				
			}
		});
		...
		radButGray.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Color("gray"));
			}
		});
		...
		radButBlack.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Color("black"));
				}
		});
		...
		radButWhite.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Color("white"));
			}
		});
		...
		radButDiesel.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Motor("diesel"));
			}
		});
		...
		radButBenzine.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Motor("benzine"));				
			}
		});
		...
		radButColorI.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Interior("black","polyester"));
			}
		});
		...
		radButMaterial.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Interior("white","leather"));				
			}
		});
		...
		checkBoxNavigation.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Tehnologies(true,false,false));
			}
		});
		...
		checkBoxBluetooth.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Tehnologies(false,true,false));				
			}
		});
		...
		checkBoxCruiseControl.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				coupe1.joinConfigurator(new Tehnologies(false,false,true));				
			}
		});
       ...
       // model.addColumn("Tech");
		...
		btnCalculatePrice.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				String output = String.format(" %.8s", coupe1.getPrice());
				text.setText("Coupe - price: "+ output);
				//text2.setText("Sedan1 - configurations: "+ sedan1.getConfigSelected());
				JOptionPane.showMessageDialog(new JFrame(),coupe1.getConfigSelected());
			}
		});
