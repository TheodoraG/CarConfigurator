...
public class SedanWindow extends JFrame{

/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	String imgPath2 = ".\\src\\CarConfigurat\\sedan.jpg";
	...
	public SedanWindow() {
		...
		radButBlue.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Color("blue"));				
			}
		});
		...
		radButGray.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Color("gray"));
			}
		});
		...
		radButBlack.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Color("black"));
				}
		});
		...
		radButDiesel.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Motor("diesel"));
			}
		});
		...
		radButColorI.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Interior("black","polyester"));
			}
		});
		...
		radButMaterial.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Interior("white","leather"));				
			}
		});
		...
		checkBoxNavigation.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Tehnologies(true,false,false));
			}
		});
		...
		checkBoxBluetooth.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Tehnologies(false,true,false));				
			}
		});
		...
		checkBoxCruiseControl.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				sedan1.joinConfigurator(new Tehnologies(false,false,true));				
			}
		});
       ...
       // model.addColumn("Tech");
		...
		btnCalculatePrice.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				String output = String.format(" %.8s", sedan1.getPrice());
				text.setText("Sedan1 - price: "+ output);
				//text2.setText("Sedan1 - configurations: "+ sedan1.getConfigSelected());
				JOptionPane.showMessageDialog(new JFrame(),sedan1.getConfigSelected());
			}
		});
