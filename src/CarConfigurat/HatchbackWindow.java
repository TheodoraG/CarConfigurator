...
public class HatchbackWindow extends JFrame{

	private static final long serialVersionUID = 1L;
	String imgPath2 = ".\\src\\CarConfigurat\\hatchback.jpg";
	...
	public HatchbackWindow() {
		this.setSize(400,400);
		this.setTitle("Hatchback");
		...
		Hatchback hatchback1 = new Hatchback(25000.00);
		
		radButBlue.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Color("blue"));				
			}
		});
		...
		radButGray.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Color("gray"));
			}
		});
		...
		radButBlack.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Color("black"));
				}
		});
		...
		radButWhite.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Color("white"));
			}
		});
		...
		radButDiesel.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Motor("diesel"));
			}
		});
		...
		radButBenzine.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Motor("benzine"));				
			}
		});
		...
		radButColorI.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Interior("black","polyester"));
			}
		});
		...
		radButMaterial.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Interior("white","leather"));				
			}
		});
		...
		checkBoxNavigation.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Tehnologies(true,false,false));
			}
		});
		...
		checkBoxBluetooth.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Tehnologies(false,true,false));				
			}
		});
		...
		checkBoxCruiseControl.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				hatchback1.joinConfigurator(new Tehnologies(false,false,true));				
			}
		});
       ...
       // model.addColumn("Tech");
		...
		btnCalculatePrice.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				String output = String.format(" %.8s", hatchback1.getPrice());
				text.setText("Hatckback1 - price: "+ output);
				//text2.setText("Sedan1 - configurations: "+ sedan1.getConfigSelected());
				JOptionPane.showMessageDialog(new JFrame(),hatchback1.getConfigSelected());
			}
		});
